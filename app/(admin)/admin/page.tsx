...
export default async function AdminDashboard() {
  ...
  return (
    <div className="space-y-6">
            ...
            {[
              ...
              <div key={item.label}>
                ...
                <div className="h-2 bg-gray-800 rounded-full overflow-hidden">
                  <div
                    className={`h-full ${item.color} rounded-full transition-all duration-500 shadow-lg`}
      ...
      <div className="bg-linear-to-r from-gray-900 to-gray-800 rounded-2xl p-6 border border-gray-800">
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
          <div>
            ...
            <p className="text-gray-400 text-sm mt-1">
              Create and publish listings in minutes with our streamlined
              workflow.
            </p>
          </div>
          <button className="px-5 py-2.5 bg-white text-black font-medium rounded-lg hover:bg-gray-100 transition-colors shadow-lg whitespace-nowrap flex items-center gap-2">
            <BsPlus className="w-4 h-4" />
            Add Property
          </button>
        </div>
