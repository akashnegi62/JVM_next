...
export default function Slider() {
  ...
  // Parallax Logic inside the card
  ...
  return (
    <section className="min-h-screen bg-neutral-950 text-white py-20 px-4 md:px-10 overflow-hidden relative font-sans">
      {/* Header */}
      <div className="max-w-7xl mx-auto flex justify-between items-end mb-12 z-20 relative">
        ...
        >
          <h2 className="text-4xl md:text-5xl font-light tracking-wide text-neutral-200">
            News &{" "}
        ...
        <div className="flex gap-4">
          <button
            onClick={() => paginate(-1)}
            className="p-4 border border-neutral-800 rounded-full hover:bg-white hover:text-black hover:border-white transition-all duration-300 group"
